...
+ [8. neural network (CIFAR-10)](https://github.com/AlexanderSipko/cifar_10_torch_81_percent) // Этот проект представляет собой пример простого классификатора изображений
